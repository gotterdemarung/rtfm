...
оголосити інтерфейс можна, але ключового слова `impements` або `extends` тут намає - 
...
- Слайс або массив, або мапа будь-якого типу не може автоматично бути представлена як 
  ...
  спеціфікою роботи із пам'ятью та зберіганнім інтерфейсів у ній.
- Є можливість оголошувати порожній інтерфейс `inteface{}` - в такому випадку будь-що 
...
`string`. Немає ні стейтрейсу, ні `cause` - хоча ніщо не заважад вам самим написати структуру, 
